...
def postBook(title, filename):
	index = {
	"title": title,
	"titleVariants": ["Beer Hetev on Shulchan Arukh, Even HaEzer", "Be'ir Hetev on Shulchan Arukh, Even HaEzer", "Ba'er Hetev on Shulchan Arukh, Even HaEzer","Beir Hetev on Shulchan Arukh, Even HaEzer", "Baer Hetev on Shulchan Arukh, Even HaEzer" ],
	"heTitle" : "באר היטב אבן העזר",
	"heTitleVariants" : [],
...
title = "Be'er Hetev on Shulchan Arukh, Even HaEzer";
filename = "052_באר_היטב_אבן_העזר.txt";
postBook(title, filename)

"""
Comments/Changes/Problems:

134 had a mistake on 134.2 divide. So I renumbered things.

It has 2 non-numbered simanim

(between 154 and 155:) 
So I removed line ~ סדר הגט ובו דיני העדים והבעל והסופר והאשה, וכל פרטיו, {{ובו ק''א סעיפים}}

and also by 3417 ish a removed a whole section that doesn't rigidly fit into the structure.:
