...
filename = "042_אבן העזר מנוקד.txt";
...
134 had a misplaced seif on 134.2. I removed it and shifted everything over. 

(between 154 and 155:) 
 So I removed line ~ סדר הגט ובו דיני העדים והבעל והסופר והאשה, וכל פרטיו, {{ובו ק''א סעיפים}}

and also by 3417 ish I changed the numbers to fit into the S"A format (which has 169 and Chaltizah in the same page)
